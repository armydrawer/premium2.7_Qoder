...
$ho_change = get_theme_option('ho_change', array('wtitle', 'wtext', 'ititle', 'itext', 'blocknews', 'catnews', 'partners', 'advantages', 'blocreviews', 'reserve', 'hidecurr', 'lastobmen', 'showparsers'));
...
<div class="homepage_wrap">
	...
	<?php
	if (strlen($ho_change['itext']) > 0) {
	?>
	<div class="home_text_wrap">
		<div class="home_text_ins">
			<div class="home_text_abs"></div>
			<div class="home_text_block">
				<?php if (strlen($ho_change['ititle']) > 0) { ?>
					<h1 class="home_text_title"><?php echo pn_strip_input($ho_change['ititle']); ?></h1>
				<?php } ?>
	...
	<?php 
	if (1 == $ho_change['blocreviews'] and function_exists('list_reviews')) { 
						...
						<div class="home_reviews_one <?php echo $cl; ?>">
							<div class="home_reviews_one_ins">
								...
								<div class="home_reviews_date"><?php echo $site1 . pn_strip_input($item->user_name) . $site2; ?>, <?php echo get_pn_time($item->review_date, $reviews_date_format); ?></div>
									<div class="clear"></div>
								<div class="home_reviews_content"><?php echo _span_break_words(wp_trim_words(pn_strip_input($item->review_text), 15)); ?></div>
							</div>
						</div>			
	...
	<?php if (1 == $ho_change['lastobmen'] and function_exists('get_last_bids')) { ?>
								...
								<div class="home_lchange_body">
									...
									<div class="home_lchange_why">
										...
										<div class="home_lchange_txt">
											...
											<div class="home_lchange_name"><?php echo $last_bid['currency_code_give']; ?></div>
										</div>
											<div class="clear"></div>
									</div>
									...
									<div class="home_lchange_why">
										...
										<div class="home_lchange_txt">
											...
											<div class="home_lchange_name"><?php echo $last_bid['currency_code_get']; ?></div>
										</div>
									</div>				
										<div class="clear"></div>
								</div>			
	...
	<?php
 	if (function_exists('list_view_currencies') and 1 == $ho_change['reserve']) {
		$hidecurr = explode(',', is_isset($ho_change, 'hidecurr'));
		$currencies = list_view_currencies('', $hidecurr);
		if (count($currencies) > 0) {
		?>
		<div class="home_reserv_wrap js_shwohide_wrap">
				...
				<div class="home_reserv_block">
					<div class="home_reserv_block_ins">
						...
						<div class="home_reserv_many">
							<div class="home_reserv_many_ins">
								...
								foreach ($currencies as $currency) { $r++; 
									$cl = '';
									if (0 == $r%4) { $cl .= ' last_item'; }
									if ($r > 8) { $cl .= ' hide_item'; }
								?> 
								<div class="one_home_reserv js_shwohide_item <?php echo $cl; ?>"> 
						...
						<div class="home_reserv_more_wrap">
							<a href="#" class="home_reserv_more js_shwohide_items" data-no="<?php _e('Show all', 'pntheme'); ?>" data-yes="<?php _e('Hide', 'pntheme'); ?>"><?php _e('Show all', 'pntheme'); ?></a>	
								<div class="clear"></div>
						</div>								
						<?php } ?>						
					</div>	
	...
	<?php 
 	if (function_exists('get_advantages') and 1 == $ho_change['advantages']) {
				...
				<div class="home_adv_div_wrap">
					<div class="home_adv_div">
						...
						foreach($advantages as $item) {  $r++;
							...
							<?php  
							if (0 == $r%3) { ?><div class="clear"></div><?php }
						}
						?>
	...
	?>	
	<div class="home_prate_wrap">
		<div class="home_prate_ins">
			<div class="home_prate_block">
				<div class="home_prate_blocktitle"><?php _e('Rates', 'pntheme'); ?></div>
				...
				<div class="home_prate_div_wrap">
					<div class="home_prate_div">
						...
						foreach ($items as $item) {  $r++;
							...
							if (0 == $r%3) { $cl = 'last_item'; }
							?>
								<div class="home_prate_one <?php echo $cl; ?>">
									<div class="home_prate_source"><?php echo get_parser_source($item); ?></div>
									<div class="home_prate_rates"><?php echo get_parser_rate_give($item, 8); ?><span><?php echo get_parser_give($item); ?></span> = <?php echo get_parser_rate_get($item, 8); ?><span><?php echo get_parser_get($item); ?></span></div>
								</div>
							<?php  
							if (0 == $r%3) { ?><div class="clear"></div><?php }
						}
	...
	<?php 
 	if (function_exists('get_partners') and 1 == $ho_change['partners']) {
				...
				foreach ($partners as $item) { 
					...
					?>
						<div class="home_partner_one">
							<?php if ($link) { ?><a href="<?php echo $link; ?>" rel="nofollow noreferrer noopener" target="_blank" title="<?php echo get_partner_title($item); ?>"><?php } ?>
