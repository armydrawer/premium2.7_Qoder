...
function def_pn_theme_footer_option($options) {
	...
	$options['vk'] = array(
		'view' => 'inputbig',
		'title' => sprintf(__('Link to %s', 'pntheme'), 'Vk.com'),
	...
	$options['fb'] = array(
		'view' => 'inputbig',
		'title' => sprintf(__('Link to %s', 'pntheme'), 'Facebook'),
	...
	$options['tw'] = array(
		'view' => 'inputbig',
		'title' => sprintf(__('Link to %s', 'pntheme'), 'Twitter'),
	...
	$options['ins'] = array(
		'view' => 'inputbig',
		'title' => sprintf(__('Link to %s', 'pntheme'), 'Instagram'),
