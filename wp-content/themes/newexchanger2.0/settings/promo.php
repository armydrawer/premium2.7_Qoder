...
global $wpdb;
	...
	$options['button'] = array(
		...
		'default' => is_isset($change,'button'),
		'name' => 'button',
		'work' => 'input',
		'ml' => 1,
	);
	$options['button_link'] = array(
		'view' => 'inputbig',
		'title' => __('Link button', 'pntheme'),
		'default' => is_isset($change,'button_link'),
		'name' => 'button_link',
		'work' => 'input',
		'ml' => 1,
	);
...
function pn_theme_promo_inbids($change){
	...
	$inbids = is_isset($change, 'inbids'); if(!is_array($inbids)) { $inbids = array(); }
?>
	<div class="premium_standart_line">
		<div class="premium_stline_left"><div class="premium_stline_left_ins"><?php _e('Block in bids if status','pntheme'); ?></div></div>
...
global $wpdb;
	...
	$change['button'] = $data['button'];
	$change['button_link'] = $data['button_link'];
