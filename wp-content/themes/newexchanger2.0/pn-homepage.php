...
$ho_change = get_theme_option('ho_change', array('wtitle','wtext','ititle','itext','iimg','blocknews','catnews','partners','advantages','blocreviews','reserve','hidecurr','lastobmen','showparsers'));
...
<?php //notification block ?>
	...
	if (strlen($ho_change['wtext']) > 0) {
        ...
        <div class="container">
            <div class="disclaimer">
                <h2 class="h2-title mb-m-5"><?php echo pn_strip_input($ho_change['wtitle']); ?></h2>
	...
	?>
	<section class="section hometext-wrapper container mb-m-50 mb-t-50 mb-40">
		<div class="hometext-wrapper_ins container">

			<div class="hometext-wrapper__text">
				<h1 class="hometext-wrapper__title main-title mb-20"><?php echo pn_strip_input($ho_change['ititle']); ?></h1>
				<?php echo apply_filters('the_content',$ho_change['itext']); ?>
			</div>
			<?php if($ho_change['iimg']){ ?>
			    <img src="<?php echo $ho_change['iimg']; ?>" class="hometext-wrapper__img" alt="picture_phone"/>
			<?php }?>
		</div>
	</section>
	<?php }
	...
	<div class="can-bg-wrapper">
				...
				<div class="section_ins container">
					<div class="section_content_wrapper">
						...
						<div class="section__title mb-20">
							<h2 class="main-title h2-title"><?php _e('Reviews','pntheme'); ?></h2>
							<a href="<?php echo $review_url; ?>" class="btn btn-secondary btn-reviews"><?php _e('All reviews','pntheme'); ?></a>
						</div>
		...
		<?php
		if($ho_change['lastobmen'] == 1 and function_exists('get_last_bids')){
			?>
			<section class="section last-exchanges">
				<div class="section_ins container">
					<div class="section_content_wrapper">
						...
						<div class="section__title mb-20">
							<h2 class="main-title h2-title"><?php _e('Last exchanges','pntheme'); ?></h2>
						</div>
			...
			<section class="section news-section">
				<div class="section_ins container">
					<div class="section_content_wrapper">
						...
						<div class="section__title mb-20">
							<h2 class="main-title h2-title"><?php _e('News','pntheme'); ?></h2>
							<a href="<?php echo $blog_url ?>" class="btn btn-secondary btn-news"><?php _e('All news','pntheme'); ?></a>
						</div>
							...
							<div class="news">
								...
								<div class="news__content <?php if (!$image) { echo 'border-top'; } ?>">
									<div>
										...
										<h4 class="h4-title"><?php echo pn_strip_input(ctv_ml($item->post_title)); ?></h4>
			...
			<section class="section home-reserve">
				<div class="section_ins container">
					<div class="section_content_wrapper">
						...
						<div class="section__title mb-20">
							<h2 class="main-title h2-title"><?php _e('Currency reserve','pntheme'); ?></h2>
							<a href="#" class="btn btn-secondary show-more-reserve" data-show-text="<?php _e('Show all','pntheme'); ?>" data-hide-text="<?php _e('Hide','pntheme'); ?>"><?php _e('Show all','pntheme'); ?></a>
						</div>
			...
			<section class="home_prate_wrap filled mb-m-40 mb-12">
				<div class="home_prate_ins">
					...
					<div class="home_prate_block">
						<div class="home_prate_blocktitle main-title h2-title mb-20"><?php _e('Rates','pntheme'); ?></div>
		...
		<?php
	 	if (function_exists('get_parser_list')) {
			...
			if (is_array($items) and count($items) > 0) {
		?>
		<section class="widget_cbr_div homepage_version courses-section">
			...
			<div class="home_stat_ins container">
				<div class="section_content_wrapper">
					<div class="section__title">
						<h2 class="main-title h2-title mb-20"><?php _e('Statistic','pntheme'); ?></h2>
					</div>
		...
		<section class="section partners-section">
			<div class="section_ins container">
				<div class="section_content_wrapper">
					...
					<h2 class="main-title h2-title partners-title"><?php _e('Partners','pntheme'); ?></h2>
