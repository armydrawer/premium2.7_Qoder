	...
	class AP_Bitconce {
		...
		function get_balance() {
			...
			if (isset($res['status'], $res['data']['balance'], $res['data']['balance_fiat']) and 'success' == $res['status']) {
				...
				$balance = array(
					'rub' => str_replace(array(' ', ','),array('', '.'), $res['data']['balance_fiat']),
		...
		function create_order($amount, $account = '') {
		...
		function get_payout($order_id, $account, $amount, $dir, $bank_name = '') {
