...
if (!class_exists('AP_Exnode')) {
	class AP_Exnode {
		...
		function create_payout($currency_code, $sum, $client_transaction_id, $call_back_url, $receiver, $dest_tag = '') {
		...
		function create_invoice($currency_code, $trans_id, $call_back_url, $client_id, $transaction_description = '') {
