...
add_filter('pn_adminpage_title_pn_hotkey_bids', 'pn_admin_title_pn_hotkey_bids');
function pn_admin_title_pn_hotkey_bids() {
	
	return __('Hotkeys settings', 'pn');
}

add_action('pn_adminpage_content_pn_hotkey_bids', 'def_adminpage_content_pn_hotkey_bids');
function def_adminpage_content_pn_hotkey_bids() {
	global $wpdb;
