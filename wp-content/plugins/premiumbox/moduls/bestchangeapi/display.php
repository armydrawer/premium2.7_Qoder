...
add_action('premium_request_displayrating_bestchangeapi', 'displayrating_bestchangeapi');
function displayrating_bestchangeapi() {
	...
	if (current_user_can('administrator') or current_user_can('pn_bestchangeapi')) {	
		...
		$items = get_bestchangeapi_rates($v1, $v2, $city_id, $min_res);
		...
		if (3 != $float_course) {
			...
			$disable_security = intval($premiumbox->get_option('bestchangeapi', 'secury'));
...
<head>
	...
	<link rel='stylesheet' href='<?php echo $plugin_url; ?>moduls/bestchangeapi/style.css?ver=<?php echo time(); ?>' type='text/css' media='all' />	
</head>
<body <?php body_class(); ?>>
<div class="container">
	<div class="table_wrap">
		<div class="table_inner">
			...
			<div class="table_select">
				<?php
				$url = get_request_link('displayrating_bestchangeapi', 'html') . '?v1=' . $v1 . '&v2=' . $v2 . '&city_id=' . $city_id . '&minres=' . $min_res . '&float_course=';
				?>
