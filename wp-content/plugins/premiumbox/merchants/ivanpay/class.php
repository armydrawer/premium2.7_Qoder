...
if (!class_exists('M_IVANPAY')) {
    class M_IVANPAY {
        ...
        function createIncomingPayFast($data) {

            return $this->request('/createIncomingPayFast', $data, 1);
        }

        function createIncomingSbpPayFast($data) {

            return $this->request('/createIncomingSbpPayFast', $data, 1);
        }

        function checkIncomePaymentAlarm($id) {

            return $this->request('/checkIncomePaymentAlarm', array('payment_id' => $id), 1);
        }
        ...
        function setPaymentExtTransactionInfo($data) {

            return $this->request('/setPaymentExtTransactionInfo', $data, 1);
        }
