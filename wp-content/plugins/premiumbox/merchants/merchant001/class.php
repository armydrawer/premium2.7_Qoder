...
if (!class_exists('M_MERCHANT001')) {
    class M_MERCHANT001 {
        ...
        function payment_methods() {
            ...
            return $this->request('/v2/payment-method/merchant/available');
        }

        function create_transaction($data) {
			
            return $this->request('/v1/transaction/merchant', $data, 1);
        }

        function get_requisites($id) {
			
            return $this->request('/v1/transaction/merchant/requisite/' . $id);
        }
