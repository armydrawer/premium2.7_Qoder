...
if (is_admin()) {
	...
	add_filter('pn_adminpage_title_pn_cf', 'def_adminpage_title_pn_cf');
	function def_adminpage_title_pn_cf() {
		
		return __('Custom fields', 'pn');
	}

	add_action('pn_adminpage_content_pn_cf', 'def_adminpage_content_pn_cf');
	function def_adminpage_content_pn_cf() {
